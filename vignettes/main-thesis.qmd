...
Given the high dimensionality and hence high complexity of the input data coming form spatial data cubes, one may be asking how can this level of level of multidimensionality be treated and maintaned with any model? This is possible within a deep learning framework, making use of deep neural networks.
...
The main metric used for pixel-by-pixel erorr tracking is the Root Mean Squared Error (RMSE), which formula can be seen below:
